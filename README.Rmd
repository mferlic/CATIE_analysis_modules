...
The goal of CATIE_analysis_modules is to bundle the data set and code used for the CATIE Virtual days into an R project.
...
`qlaci` can be downloaded from D3C GitHub: <https://github.com/d3center-isr/qlaci>
